class bola{
    constructor(x,y,m,cor,stroke,grav){
    ...
    showVel(){
        ...
        stroke("#F00");
        fill("#F00");
        if (this.pos.y >= height-100-this.r){
            line(this.pos.x,this.pos.y,
                 this.pos.x+this.vel.x*mult,
                 this.pos.y+this.gravity.y*mult);
            return;
        }
        line(this.pos.x,this.pos.y,
             this.pos.x+this.vel.x*mult,
             this.pos.y+this.vel.y+this.gravity.y*mult);
    }
    ...
    intersects(other) {
        ...
        if (d <= this.r + other.r) {
            if(d < this.r + other.r){
                this.pos.x = this.pos.x - (this.r + other.r - d - 1);
                this.pos.y = this.pos.y - (this.r + other.r - d - 1);
                other.pos.x = other.pos.x + (this.r + other.r - d + 1);
                other.pos.y = other.pos.y + (this.r + other.r - d + 1); 
            }
