...
function prepareGui(){
    ...
    botoes.push(new botao(width/4+25,height*3/4-70,135,50,"Adicionar Caixa","#334475","#A5B5E1"));//2
    botoes.push(new botao(width*3/4-100,height*3/4-70,80,50,"Cancelar","#334475","#A5B5E1"));//3
    ...
    botoes.push(new botao(width/4+25,height*3/4-70,135,50,"Adicionar Bola","#337636","#A5E1A5"));//5
    ...
    botoes.push(new botao(width*3/4-100,height*3/4-70,80,50,"Cancelar","#767432","#ECE87D"));//4
    ...
    botoes.push(new botao(width/4+25,height*3/4-70,80,50,"Aplicar","#767432","#ECE87D"));//5
    ...
    botoes.push(new botao(width/4+125,height*3/4-70,170,50,"Restaurar Padrões","#767432","#ECE87D"));//11
    botoes[11].setFillHover("#F3F1BF"); 
    //CONFIG -------------- /\/\
    //slidersInfoY.push(sliders[sliders.lenght-1].y);
