class caixa{
    ...
    calculateColision(other){
        ...
        let Rbp = p5.Vector.sub(this.pointP,other.centerOfMass);
        ...
        e1 = p5.Vector.cross(angularLokoA,Rap);
        Vap1 = p5.Vector.add(Va1,e1);
        //
        let e2 = createVector(0,0);
        
        e2 = p5.Vector.cross(angularLokoB,Rbp);
        Vbp1 = p5.Vector.add(Vb1,e2);
        //
        ...
        let f1_3;
        f1_1 = -(1+this.e);
        f1_2 = p5.Vector.sub(other.vel,this.vel);
        f1_3 = p5.Vector.dot(f1_2,this.n);
        let f1;
        f1 = f1_1 * f1_3;
        let f2;
        f2 = (1/this.m)+(1/other.m);
        impulse = f1 / f2;
        //impulse = (-(1 + this.e)*(p5.Vector.dot(this.n,(other.vel - this.vel))))/((1/this.m) + (1/other.m)) ;
        fill(255);
        stroke("#FF1E1E");
        circle(this.centerOfMass.x,this.centerOfMass.y,2);
        circle(other.centerOfMass.x,other.centerOfMass.y,2);
        noStroke();
        text("center of mass this:  "+this.centerOfMass,10,175);
        text("center of mass other:  "+other.centerOfMass,10,200);
        text("Rap: "+Rap,10,125);
        text("Rbp: "+Rbp,10,150);
        text("impulse:"+impulse,10,250);
        //stroke("#FF1E1E");
        //circle()
